				...
				if (un != undefined) {
					...
					$.post(url, function (data) {
						...
						if (data == '(true);') {
							...
							navigator.notification.alert("Username geÃ¤ndert!", function() {}, "Succes", "OK");
						} else {
				...
				if (pw == undefined || pw != pw2) {
					...
					$.post(url, function (data) {
						...
						if (data == '(true);') {
							...
							navigator.notification.alert("Passwort geÃ¤ndert!", function() {}, "Succes", "OK");
						} else {
							//alert("Fehler beim update");
							navigator.notification.alert("Fehler beim update", function() {}, "Error", "OK");
						}	
				...
				if (newem != undefined) {
					...
					$.post(url, function (data) {
						...
						if (data == '(true);') {
							...
							navigator.notification.alert("Email geÃ¤ndert!", function() {}, "Succes", "OK");
						} else {
							//alert("Fehler beim update");
							navigator.notification.alert("Fehler beim update", function() {}, "Error", "OK");
						}	
